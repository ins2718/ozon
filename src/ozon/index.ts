            ...
            if (this.findOzonItem(code)) {
                ...
                if (this.pageWorker.pageType === "ozonReceive") {
                    ...
                    fetch("https://api.limpiarmuebles.pro/ozon-codes", {
                        ...
                        el.innerHTML = `<div class="_logContent_${hash}_11"><div class="_addressInner_${hash}_82"><div class="_addressBadge_${hash}_87 ozi-heading-500 _addressBadgeDefault_${hash}_114" data-testid="logItemPlace">${resp.data.shelf}-${resp.data.num}</div><div><button data-testid="relocateBtn" type="submit" class="ozi__button__button__maF2e ozi__button__size-400__maF2e ozi-body-500-true ozi__button__uncontained__maF2e ozi__button__hug__maF2e ozi__button__light__maF2e ozi__button__noLeftRadius__maF2e ozi__button__noRightRadius__maF2e"><div class="ozi__button__content__maF2e"><!----><div class="ozi__truncate__truncate__7a-6_ ozi__button__text__maF2e">Изменить</div><!----></div><!----></button><!----></div></div><div class="_logItem_${hash}_17"><div class="_logTitle_${hash}_23"><div class="ozi__text-view__textView__ff2BT ozi__text-view__headline-h5__ff2BT ozi-heading-100 ozi__text-view__light__ff2BT ozi__text-view__paddingBottomOff__ff2BT ozi__text-view__paddingTopOff__ff2BT">Отправление ${resp.data.code}</div><span class="_logDate_${hash}_29">${resp.data.created_at}</span></div><div class="ozi__text-view__textView__ff2BT ozi__text-view__caption-medium__ff2BT ozi-body-500 ozi__text-view__light__ff2BT ozi__text-view__paddingBottomOff__ff2BT ozi__text-view__paddingTopOff__ff2BT ozi__text-view__caption__ff2BT">Предмет уже числится на складе. Воспользуйтесь поиском отправлений, чтобы убедиться в этом.</div><div class="_info_${hash}_47 _infoInner_${hash}_52"><button data-testid="compositionBtn" type="submit" class="ozi__button__button__maF2e ozi__button__size-400__maF2e ozi-body-500-true ozi__button__uncontained__maF2e ozi__button__hug__maF2e ozi__button__light__maF2e ozi__button__hasLeftIcon__maF2e ozi__button__noLeftRadius__maF2e ozi__button__noRightRadius__maF2e"><div class="ozi__button__content__maF2e"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" class="" viewBox="0 0 24 24"><path fill="currentColor" d="M6.293 9.293a1 1 0 0 1 1.414 0L12 13.586l4.293-4.293a1 1 0 1 1 1.414 1.414l-5 5a1 1 0 0 1-1.414 0l-5-5a1 1 0 0 1 0-1.414"></path></svg><div class="ozi__truncate__truncate__7a-6_ ozi__button__text__maF2e">Состав отправления</div><!----></div><!----></button><!----></div></div></div>`;
